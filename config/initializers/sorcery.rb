...
Rails.application.config.sorcery.submodules = [:external, :remember_me, :activity_logging, :reset_password]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `[]`
  #
  config.external_providers = [ :facebook, :twitter, :github ]
  ...
  config.facebook.callback_url = "#{ENV["SERVICE_URL"]}/oauths/callback?provider=facebook"
